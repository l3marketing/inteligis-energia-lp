...
if (typeof window !== "undefined") {
  try {
    const raw = window.localStorage.getItem("inteligis:integrations");
    if (raw) {
...
if (gtm && statuses.gtm && typeof window !== "undefined") {
...
if (ga4 && statuses.ga && typeof window !== "undefined") {
...
if (metaPixel && statuses.metaPixel && typeof window !== "undefined") {
...
if (tiktokPixel && statuses.tiktok && typeof window !== "undefined") {
